...
if selected_page == "DataFrame":
    ...
    path = "C:\Users\Admin\Documents\Main Project\Dataset.csv"
    df = pd.read_csv(path)
    st.dataframe(df)
...
df1 = pd.read_csv('C:\Users\Admin\Documents\Main Project\Final\df1.csv')  
...
model = load_model('C:\Users\Admin\Documents\Main Project\Final\random_forest_model (1).pkl')
...
if selected_page == "Recommendations":
    ...
    movies_data = pd.DataFrame.from_dict(pickle.load(open('C:\Users\Admin\Documents\Main Project\Final\movies (1).pkl', 'rb')))
    similarity_data = pickle.load(open('C:\Users\Admin\Documents\Main Project\Final\similarity.pkl', 'rb'))
